    ...
    <section id="pricing" className="bg-[var(--background)] md:py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-16 gap-8 items-center">
          ...
          >
            <div>
              <h2 className="text-4xl md:text-6xl font-extrabold text-theme leading-tight mb-6">
                {t("pricing.title")} <br />
              ...
              <p className="text-theme-muted text-base sm:text-lg lg:text-xl leading-relaxed">
            ...
            <div className="flex items-start gap-4 p-4 rounded-2xl bg-[var(--card-bg)] border border-[var(--border-color)] max-w-md">
              <HelpCircle className="text-purple-400 shrink-0 mt-1" size={20} />
              <p className="text-xs text-theme-light italic">
                {t("pricing.helpText")}
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-[var(--card-bg-solid)] border border-[var(--border-color)] rounded-3xl p-8 md:p-12 shadow-lg overflow-hidden">
              <div className="mb-8">
                <span className="text-xs font-bold text-purple-400 uppercase tracking-widest">
                  {t("pricing.badge")}
                </span>
                <h3 className="text-2xl font-bold text-theme mt-2">
                  {t("pricing.subtitle")}
                </h3>
                <p className="text-theme-light text-sm mt-1">
                  {t("pricing.subtitleDescription")}
                </p>
              </div>

              <div className="mb-8">
                <div className="text-theme text-2xl md:text-4xl font-bold">
              ...
              <div className="space-y-5 mb-10">
                {features.map((item, i) => (
                  <div key={i} className="flex items-center gap-4">
                    <div className="w-8 h-8 rounded-lg bg-[var(--card-bg)] flex items-center justify-center text-purple-400 border border-[var(--border-color)]">
                      <item.icon size={16} />
                    </div>
